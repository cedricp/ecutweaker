...
public class EcuDatabase {
    ...
    private void loadAddressing() {
        ...
        String addressing = getResourceAsString(addressingResource);

        try {
            JSONObject jobj = new JSONObject(addressing);
